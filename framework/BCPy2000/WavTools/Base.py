# -*- coding: utf-8 -*-
# 
#   $Id: Base.py 3326 2011-06-17 23:56:38Z jhill $
#   
...
class wav:
	def __init__(self, filename=None, fs=None, bits=None, nchan=2):
		...
		if self.fs==None and fs==None: fs = 44100
		if fs != None: self.fs = fs
		if bits != None: self.bits = bits
	...
	def cut(self, start=None, stop=None):
		...
		if stop == None: stop = self.duration()
